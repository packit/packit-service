...
class TestEvents:
    ...
    @pytest.fixture()
    def koji_build_start_old_format(self):
        with open(
            DATA_DIR / "fedmsg" / "koji_build_start_old_format.json", "r"
        ) as outfile:
            return json.load(outfile)

    @pytest.fixture()
    def koji_build_start_rawhide(self):
        with open(
            DATA_DIR / "fedmsg" / "koji_build_start_rawhide.json", "r"
        ) as outfile:
            return json.load(outfile)

    @pytest.fixture()
    def koji_build_start_f35(self):
        with open(DATA_DIR / "fedmsg" / "koji_build_start_f35.json", "r") as outfile:
            return json.load(outfile)

    @pytest.fixture()
    def koji_build_start_epel8(self):
        with open(DATA_DIR / "fedmsg" / "koji_build_start_epel8.json", "r") as outfile:
            return json.load(outfile)

    @pytest.fixture()
    def koji_build_completed_old_format(self):
        with open(
    ...
    @pytest.fixture()
    def koji_build_completed_rawhide(self):
        with open(
    ...
    @pytest.fixture()
    def koji_build_completed_f35(self):
        with open(
            DATA_DIR / "fedmsg" / "koji_build_completed_f35.json", "r"
        ) as outfile:
            return json.load(outfile)

    @pytest.fixture()
    def koji_build_completed_epel8(self):
        with open(
            DATA_DIR / "fedmsg" / "koji_build_completed_epel8.json", "r"
        ) as outfile:
            return json.load(outfile)
