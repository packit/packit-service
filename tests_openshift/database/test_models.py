...
def test_tmt_test_run_set_web_url(
    clean_before_and_after, srpm_build_model_with_new_run_and_tf_for_pr
):
    _, tf_group_model, run_model = srpm_build_model_with_new_run_and_tf_for_pr
...
def test_tmt_test_get_by_pipeline_id_pr(
    clean_before_and_after, pr_model, srpm_build_model_with_new_run_and_tf_for_pr
):
    _, tf_group_model, run_model = srpm_build_model_with_new_run_and_tf_for_pr
    test_run_model = TFTTestRunTargetModel.create(
        pipeline_id="123456",
